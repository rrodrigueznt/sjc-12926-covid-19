    ...
    navlistPanel(widths = c(3, 9), id="panels",
      ...
      navbarMenu("Testing",
                 ...
                 tabPanel("County + DOC: Tests", 
                          wellPanel(id="internal_well",
                                    ...
                                    radioButtons("select_tested", label = NULL, 
                 ...
                 tabPanel("DOC Facilities: Tests", 
                          wellPanel(id="internal_well",
                                    p("Select kind of individual:", id="radio_prompt"),
                                    radioButtons("select_tests_fac", label = NULL, 
                                                 selected = "All" , inline = T, 
                                                 choiceNames = c("All", "Prisoners", "Staff", "Total"),
                                                 choiceValues = c("All", "Prisoners", "Staff", "Total")),
                 ...
                 tabPanel("Multi-Facility Counties: Tests", 
                          wellPanel(id="internal_well",
                                    p("Select kind of individual:", id="radio_prompt"),
                                    radioButtons("select_tests_cty", label = NULL, 
                                                 selected = "All" , inline = T, 
                                                 choiceNames = c("All", "Prisoners", "Staff", "Total"),
                                                 choiceValues = c("All", "Prisoners", "Staff", "Total")),
                                    em('Exact number of tests per facility annotated in',
      ...
      navbarMenu("Positive Tests",
                 ...
                 tabPanel("County + DOC: Positive Tests", 
                          wellPanel(id="internal_well",
                                    p("Select kind of individual:", id="radio_prompt"),
                                    radioButtons("select_positive", label = NULL, 
                                                 selected = "All" , inline = T, 
                                                 choiceNames = c("All", "Prisoners", "Staff", "Total"),
                                                 choiceValues = c("All", "Prisoners", "Staff", "Total")),
                 ...
                 tabPanel("DOC Facilities: Positive Tests", 
                          wellPanel(id="internal_well",
                                    p("Select kind of individual:", id="radio_prompt"),
                                    radioButtons("select_positive_fac", label = NULL, 
                                                 selected = "All" , inline = T, 
                                                 choiceNames = c("All", "Prisoners", "Staff", "Total"),
                                                 choiceValues = c("All", "Prisoners", "Staff", "Total")),
                 ...
                 tabPanel("Multi-Facility Counties: Positive Tests", 
                          wellPanel(id="internal_well",
                                    p("Select kind of individual:", id="radio_prompt"),
                                    radioButtons("select_positive_cty", label = NULL, 
                                                 selected = "All" , inline = T, 
                                                 choiceNames = c("All", "Prisoners", "Staff", "Total"),
                                                 choiceValues = c("All", "Prisoners", "Staff", "Total")),
                                    em('Exact number of positive tests per facility annotated in',
      ...
      navbarMenu("Active Cases",
                 ...
                 tabPanel("Multi-County Facilities: Active Positive Cases",
                          wellPanel(id="internal_well",
                                    p("Select kind of individual:", id="radio_prompt"),
                                    radioButtons("select_active_cty", label = NULL, 
                                                 selected = "All" , inline = T, 
                                                 choiceNames = c("All", "Prisoners", "Staff", "Total"),
                                                 choiceValues = c("All", "Prisoners", "Staff", "Total")),
                                    em('Exact number of tests per facility annotated in',
